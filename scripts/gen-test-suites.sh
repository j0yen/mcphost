...
# non-deferred AC, same per-AC consolidation convention) tip core's normal
# buckets from 2 to 3 again once enough of them land, spawning an 11th
# suite binary -- caught by the same
# `suite_ac1_ten_binaries_and_names_preserved` P0 assertion. This value is
# regenerated by this script once every AC file in this PRD has landed;
# see the "export: fix post-rebase" commit for the final recount.
